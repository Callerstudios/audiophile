...
const ProductDetail: React.FC<ProductProps> = ({
  ...
  return (
    <div className="flex flex-col md:flex-row h-160 text-center gap-5 md:gap-20 w-full justify-between items-center">
      <img
        src={image}
        alt=""
        className={`h-120 min-w-[50%] md:h-full object-center object-cover ${imageRight ? "order-2" : ""}`}
      />
      <div
